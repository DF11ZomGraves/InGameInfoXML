...
public abstract class TagPlayerPosition extends Tag {
    ...
    public static class X extends TagPlayerPosition {
        @Override
        public String getValue() {
            return String.format(Locale.ENGLISH, "%.2f", player.getX());
        }
    }
    ...
    public static class Y extends TagPlayerPosition {
        @Override
        public String getValue() {
            return String.format(Locale.ENGLISH, "%.2f", player.getY());
        }
    }
    ...
    public static class YEye extends TagPlayerPosition {
        @Override
        public String getValue() {
            return String.format(Locale.ENGLISH, "%.2f", player.getY() + player.getEyeHeight());
        }
    }
    ...
    public static class Z extends TagPlayerPosition {
        @Override
        public String getValue() {
            return String.format(Locale.ENGLISH, "%.2f", player.getZ());
        }
    }
    ...
    public static class YEyei extends TagPlayerPosition {
        @Override
        public String getValue() {
            return String.valueOf(Mth.floor(player.getY() + player.getEyeHeight()));
        }
    }
    ...
    public static class Pitch extends TagPlayerPosition {
        @Override
        public String getValue() {
            return String.format(Locale.ENGLISH, "%.2f", player.getYRot());
        }
    }
    ...
    public static class Direction extends TagPlayerPosition {
        @Override
        public String getValue() {
            float direction = player.getYRot() % 360;
            if (direction >= 180) {
                direction -= 360;
    ...
    public static class RoughDirection extends TagPlayerPosition {
        @Override
        public String getValue() {
            return ROUGHDIRECTION[Mth.floor(player.getYRot() * 4.0 / 360.0 + 0.5) & 3];
        }
    }
    ...
    public static class FineDirection extends TagPlayerPosition {
        @Override
        public String getValue() {
            return FINEDIRECTION[Mth.floor(player.getYRot() * 8.0 / 360.0 + 0.5) & 7];
        }
    }
    ...
    public static class AbbreviatedRoughDirection extends TagPlayerPosition {
        @Override
        public String getValue() {
            return ABRROUGHDIRECTION[Mth.floor(player.getYRot() * 4.0 / 360.0 + 0.5) & 3];
        }
    }
    ...
    public static class AbbreviatedFineDirection extends TagPlayerPosition {
        @Override
        public String getValue() {
            return ABRFINEDIRECTION[Mth.floor(player.getYRot() * 8.0 / 360.0 + 0.5) & 7];
        }
    }
    ...
    public static class AxisDirection extends TagPlayerPosition {
        @Override
        public String getValue() {
            return AXISDIRECTION[Mth.floor(player.getYRot() * 4.0 / 360.0 + 0.5) & 3];
        }
    }
    ...
    public static class DirectionHud extends TagPlayerPosition {
        @Override
        public String getValue() {
            final int direction = Mth.floor(player.getYRot() * 16.0f / 360.0f + 0.5) & 15;
