...
public abstract class TagMisc extends Tag {
	...
	public static class NeoForgeVersion extends TagMisc {
		@Override
		public String getValue() {
			return net.neoforged.neoforge.internal.versions.neoforge.NeoForgeVersion.getVersion();
		}
	}
	...
	public static void register() {
		...
		TagRegistry.INSTANCE.register(new NeoForgeVersion().setName("neoforgeversion"));
