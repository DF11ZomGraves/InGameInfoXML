...
import df11zomgraves.ingameinfo.handler.ForgeClientEventHandler;
import df11zomgraves.ingameinfo.handler.KeyInputHandler;
...
public class InGameInfoXML {
	...
	private void clientSetup(final FMLClientSetupEvent event) {
		...
		bus.register(new ForgeClientEventHandler());
		...
		ConfigurationHandler.applyConfiguration(false);
