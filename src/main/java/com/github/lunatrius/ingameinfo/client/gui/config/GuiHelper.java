...
public class GuiHelper {
	...
	public static void drawTexturedRectangle(final BufferBuilder buffer, final double x0, final double y0,
			final double x1, final double y1, final double z, final double u0, final double v0, final double u1,
			final double v1) {
	...
	public static void drawTexturedRectangle(final BufferBuilder buffer, final double x0, final double y0,
			final double x1, final double y1, final double z, final double textureWidth, final double textureHeight,
			final int argb) {
	...
	public static void drawTexturedRectangle(final BufferBuilder buffer, final double x0, final double y0,
			final double x1, final double y1, final double z, final double u0, final double v0, final double u1,
			final double v1, final int argb) {
	...
	public static void drawTexturedRectangle(final BufferBuilder buffer, final double x0, final double y0,
			final double x1, final double y1, final double z, final double u0, final double v0, final double u1,
			final double v1, final int r, final int g, final int b, final int a) {
	...
	public static void drawColoredRectangle(final BufferBuilder buffer, final double x0, final double y0,
			final double x1, final double y1, final double z, final int r, final int g, final int b, final int a) {
	...
	public static void drawVerticalGradientRectangle(final BufferBuilder buffer, final double x0, final double y0,
			final double x1, final double y1, final double z, final int startColor, final int endColor) {
	...
	public static void drawVerticalGradientRectangle(final BufferBuilder buffer, final double x0, final double y0,
			final double x1, final double y1, final double z, final int sr, final int sg, final int sb, final int sa,
			final int er, final int eg, final int eb, final int ea) {
