...
public abstract class TagPlayerEquipment extends Tag {
	...
	public static class DamageLeft extends TagPlayerEquipment {
		...
		public String getValue() {
			...
			return String.valueOf(
					itemStack.isItemStackDamageable() ? itemStack.getMaxDamage() - itemStack.getItemDamage() : 0);
		}
	}
	...
	public static class Quantity extends TagPlayerEquipment {
		...
		public String getValue() {
			...
			return String.valueOf(EntityHelper.getItemCountInInventory(player.inventory, itemStack.getItem(),
