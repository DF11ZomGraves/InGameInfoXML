...
public abstract class TagPlayerGeneral extends Tag {
	...
	public static class Light extends TagPlayerGeneral {
		...
		public String getValue() {
			try {
				return String.valueOf(world.getChunkFromBlockCoords(playerPosition).getLightSubtracted(playerPosition,
	...
	public static class LightEye extends TagPlayerGeneral {
		...
		public String getValue() {
			try {
				...
				return String.valueOf(world.getChunkFromBlockCoords(this.pos).getLightSubtracted(this.pos,
						world.calculateSkylightSubtracted(1.0f)));
			} catch (final Exception e) {
				return "0";
			}
	...
	public static class LightSun extends TagPlayerGeneral {
		...
		public String getValue() {
			try {
				return String.valueOf(MathHelper.clamp(
						world.getLightFor(EnumSkyBlock.SKY, playerPosition) - world.calculateSkylightSubtracted(1.0f),
						0, 15));
			} catch (final Exception e) {
				return "0";
			}
	...
	public static class LightSunEye extends TagPlayerGeneral {
		...
		public String getValue() {
			try {
				this.pos.set(playerPosition.getX(), player.posY + player.getEyeHeight(), playerPosition.getZ());
				return String.valueOf(MathHelper.clamp(
						world.getLightFor(EnumSkyBlock.SKY, this.pos) - world.calculateSkylightSubtracted(1.0f), 0,
						15));
			} catch (final Exception e) {
				return "0";
			}
...
//		@Override
//		public String getValue() {
//			return String.format(Locale.ENGLISH, "%.2f", player.getFoodStats());
//		}
//	}
	...
	public static void register() {
		...
		// TagRegistry.INSTANCE.register(new
		// Exhaustion().setName("exhaustion").setAliases("foodexhaustion"));
