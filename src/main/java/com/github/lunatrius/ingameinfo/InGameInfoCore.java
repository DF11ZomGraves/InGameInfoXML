...
public class InGameInfoCore {
	...
	public void onTickRender() {
		...
		GlStateManager.scale(1.0f / ConfigurationHandler.scale, 1.0f / ConfigurationHandler.scale,
				1.0f / ConfigurationHandler.scale);
		GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
	}
	...
	public boolean reloadConfig() {
		...
		try {
			...
			minecraft.player.sendMessage(new TextComponentTranslation(e.getMessage()));
		}
